...
Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.CheckBox - User Trial'), 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.CheckBox'), 0)

Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.Button - Next'), 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.ImageButton'), 0)

Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.ImageView (1)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Android 11/android.widget.EditText - Phone number'), '8050694262')

Mobile.sendKeys(findTestObject('Object Repository/Android 11/android.widget.EditText - Password'), 'Test@123')

Mobile.tap(findTestObject('Object Repository/Android 11/android.widget.Button - Sign In'), 0)
