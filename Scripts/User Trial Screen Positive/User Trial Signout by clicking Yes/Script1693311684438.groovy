...
Mobile.tap(findTestObject('Object Repository/User Trial Signout/XCUIElementTypeButton - Signout'), 0)

Mobile.tap(findTestObject('Object Repository/User Trial Signout/XCUIElementTypeButton - Yes'), 0)
