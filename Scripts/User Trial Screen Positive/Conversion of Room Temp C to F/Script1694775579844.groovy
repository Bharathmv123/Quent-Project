...
Mobile.sendKeys(findTestObject('Object Repository/Enter Hip Size/android.widget.EditText - Room Temp'), '37.1')

Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.CompoundButton - C'), 0)

Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.CompoundButton - F'), 0)
