...
Mobile.sendKeys(findTestObject('Object Repository/Enter Hip Size/android.widget.EditText - Body Temp'), '37.1')

Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.CompoundButton - C (1)'), 0)

Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.CompoundButton - F (1)'), 0)
