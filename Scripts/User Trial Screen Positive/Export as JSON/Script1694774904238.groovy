...
Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/Enter Hip Size/android.widget.TextView - Export as JSON'), 0)
