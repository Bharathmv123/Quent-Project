...
Mobile.tap(findTestObject('Object Repository/Trial/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/Trial/androidx.appcompat.widget.LinearLayoutCompat (1)'), 0)

Mobile.delay(70)

Mobile.tap(findTestObject('Object Repository/ECG/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/ECG/android.widget.TextView - Select File'), 0)

Mobile.tap(findTestObject('Object Repository/ECG/android.widget.ImageView (2)'), 0)

Mobile.tap(findTestObject('Object Repository/SPO2/androidx.appcompat.widget.LinearLayoutCompat'), 0)

Mobile.delay(20)

Mobile.tap(findTestObject('Object Repository/Trial/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/SPO2/android.widget.ImageView (3)'), 0)

Mobile.tap(findTestObject('Object Repository/SPO2/android.widget.Button - Yes'), 0)

//BP Functionality Not Working

//Mobile.scrollToText('Blood Pressure')

//Mobile.tap(findTestObject('Object Repository/Trial/android.widget.ImageView (2)'), 0)

//Mobile.tap(findTestObject('Object Repository/Trial/androidx.appcompat.widget.LinearLayoutCompat (2)'), 0)
