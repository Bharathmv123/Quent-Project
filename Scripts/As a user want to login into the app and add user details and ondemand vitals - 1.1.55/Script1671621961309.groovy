...
Mobile.sendKeys(findTestObject('Object Repository/Pairing/android.widget.EditText - Weight'), '75')

Mobile.sendKeys(findTestObject('Object Repository/Pairing/android.widget.EditText - Height'), '165')

Mobile.sendKeys(findTestObject('Object Repository/Pairing/android.widget.EditText - Hip Size (1)'), '80')

Mobile.sendKeys(findTestObject('Object Repository/Pairing/android.widget.EditText - Wrist Size'), '18')
...
Mobile.tap(findTestObject('Object Repository/New build end to end 1.1.55/android.widget.ImageView (5)'), 0)
