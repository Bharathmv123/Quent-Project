...
Mobile.tap(findTestObject('Object Repository/Signout by Clicking NO/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/Signout by Clicking NO/android.widget.TextView - Signout'), 0)

Mobile.tap(findTestObject('Object Repository/Signout by Clicking NO/android.widget.Button - NO'), 0)
