...
Mobile.sendKeys(findTestObject('Object Repository/User Trial End to End/android.widget.EditText - Body Temp'), '37')
...
//Mobile.getText(findTestObject('Object Repository/User Trial End to End/android.widget.Toast - Please choose trial batch(1)'),
	//0)
