...
Mobile.sendKeys(findTestObject('Object Repository/User Trial End to End/XCUIElementTypeTextField - Wrist Size'), '28')
 
Mobile.delay(10)

//Mobile.scrollToText('Room Temp')

Mobile.sendKeys(findTestObject('Object Repository/User Trial End to End/XCUIElementTypeTextField - Room Temp'), '37')
