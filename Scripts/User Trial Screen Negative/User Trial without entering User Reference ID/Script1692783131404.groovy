...
Mobile.scrollToText('User Reference')

Mobile.tap(findTestObject('Object Repository/User Trial without entering User Reference ID/android.widget.TextView - User Reference ID is Mandatory'), 
    0)

Mobile.getText(findTestObject('Object Repository/User Trial without entering User Reference ID/android.widget.TextView - User Reference ID is Mandatory'),
	0)
Mobile.delay(5)
