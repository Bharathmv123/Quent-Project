...
Mobile.tap(findTestObject('Object Repository/BP Dr/android.widget.ImageView'), 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Object Repository/BP Dr/android.widget.ImageView (1)'), 0)
