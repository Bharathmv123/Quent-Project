...
Mobile.tap(findTestObject('Object Repository/Settings/android.widget.TextView - 91'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Settings/android.widget.EditText - Phone number'), '9022351287')
...
Mobile.tap(findTestObject('Object Repository/Settings/android.widget.TextView - Config Bulk'), 0)

Mobile.tap(findTestObject('Object Repository/Settings/android.widget.Button - OK'), 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Object Repository/Settings/android.widget.Button - Go to Dashboard'), 0)
