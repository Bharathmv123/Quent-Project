...
Mobile.tap(findTestObject('Object Repository/android.widget.CheckBox - User Trial'), 0)
...
Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Phone number'), '805069426274')

Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Password'), 'Test@123')
