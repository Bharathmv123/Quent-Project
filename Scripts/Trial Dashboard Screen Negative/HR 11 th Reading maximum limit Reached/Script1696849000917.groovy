...
//HR Vital Reading for First Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading for Second Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Third  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Fourth  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Fifth  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading for Sixth Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading for Seventh Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Eighth  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Nineth  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Tenth  Reading

Mobile.tap(findTestObject('Object Repository/HR/XCUIElementTypeStaticText - Measure'), 0)

Mobile.delay(30)

//HR Vital Reading Eleventh  Reading
