...
Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.ImageView'), 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.TextView - Golden Apparatus Reading'), 0)

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - PR Interval'), '100')

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - QT Interval'), '367')

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - QRS Duration'), '90')

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - RR Interval'), '588')

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.AutoCompleteTextView - Inference -1'), 0)

Mobile.switchToNative()

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - bpm'), '102')

Mobile.sendKeys(findTestObject('Object Repository/ECG Golden and Pred/android.widget.EditText - Description'), 'Please enter')

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.ImageButton'), 0)

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.TextView - Take Photo'), 0)

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.Button - Save'), 0)

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.TextView - Predicate Reading'), 0)
...
Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.Button - Save (1)'), 0)

Mobile.tap(findTestObject('Object Repository/ECG Golden and Pred/android.widget.Button - YES'), 0)
