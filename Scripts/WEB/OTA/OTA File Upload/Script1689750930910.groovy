...
WebUI.setText(findTestObject('Object Repository/OTA File Upload/Page_QuentPreUserTrail/textarea__mat-input-7'), 'Quent Release')
...
WebUI.click(findTestObject('Object Repository/OTA File Upload/Page_QuentPreUserTrail/img_1'))

WebUI.click(findTestObject('Object Repository/OTA File Upload/Page_QuentPreUserTrail/div_Logout'))
