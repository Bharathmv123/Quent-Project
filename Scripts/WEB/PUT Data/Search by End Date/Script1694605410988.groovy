...
WebUI.click(findTestObject('Object Repository/Page_QuentPreUserTrail/div_5'))

WebUI.click(findTestObject('Object Repository/Page_QuentPreUserTrail/mat-icon_search'))
