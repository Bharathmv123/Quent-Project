...
WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/img_PUT Data_date-picker ng-tns-c113-4'))

WebUI.doubleClick(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/button_QT Interval_mat-focus-indicator mat-_25192e'))

WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/button_QT Interval_mat-focus-indicator mat-_25192e'))

WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/div_3'))

WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/span_Search'))
...
WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/a_page 3'))

WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/a_page 4'))

WebUI.click(findTestObject('Object Repository/No of records per page/Page_QuentPreUserTrail/img_1_2'))
