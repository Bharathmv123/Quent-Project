...
WebUI.setText(findTestObject('Object Repository/Page_QuentPreUserTrail/input__login-phonenumber'), '8217603934')
...
WebUI.click(findTestObject('Object Repository/Page_QuentPreUserTrail/button_Close'))
